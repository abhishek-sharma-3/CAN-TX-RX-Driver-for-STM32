...
void can_filter_config(uint16_t std_id){
	...
	//set the filter to initialization mode
	CAN1->FMR |= CAN_FMR_FINIT;

	//set the slave filter to start frame 20
	...
	//clear filter initialization mode
	CAN1->FMR &=~ CAN_FMR_FINIT;
